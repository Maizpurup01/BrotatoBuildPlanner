...
Para obtener el proyecto en local, ejecuta:
...
1. Abre el proyecto desde `File → Open Project`
2. Espera a que Maven cargue las dependencias
3. Ejecuta el proyecto con `Run`
